<template>
    ...
    <div style="width: 100%;height: 100%">
        ...
        >
          <div style="padding-top: 78px">
            <div class="album-main">
              ...
              <!--          </div>-->
              <transition
                v-for="(pic,index) in picturesUrl"
                :key="index"
                name="el-fade-in"
              >
                <div
      ...
      <transition name="el-fade-in">
        <div
          v-if="isNoteBook"
          style="width: 100%;height: 100%;z-index: 2000"
        >
          <div style="padding-top: 78px">
      ...
      <transition name="el-fade-in">
        ...
        >
          <div class="font-body">
            <div
              class="font-babel"
              style="transition: 1.3s;opacity: 1"
            >
      ...
      >
        ...
        <div
          class="clickHere-son"
          style="width: 60px;text-align: center;margin-right: 30px"
          @click="clickIt"
        >Back
        </div>
      </div>
