<template>
  <div style="width: 100%; height: 100%;">
      ...
      <div v-if="isAlbum" style="width: 100%; z-index: 2000;">
        <div style="padding-top: 78px;">
          <div class="album-main">
            ...
            <!--          >-->
            <!--          </div>-->
            <transition v-for="(pic, index) in picturesUrl" :key="index" name="el-fade-in">
              <div class="photo" :style="{ backgroundImage: `url(${pic})` }" @click="seeDetail(pic)"></div>
            </transition>
          </div>
        </div>
      </div>
    ...
    >
      ...
      <div class="clickHere-son" style="width: 60px; text-align: center; margin-right: 30px;" @click="clickIt">
        Back
      </div>
    </div>
    ...
    <el-dialog title="撰写" :visible.sync="centerDialogVisible" width="92%" center>
      <el-row>
        <el-col :span="20">
...
export default {
  ...
  mounted() {
    if (process.browser) {
      let fontBabel = window.document.querySelector('.font-babel');
      ...
      this.babel1 = window.document.querySelectorAll('.babel-font')[0];
      this.babel2 = window.document.querySelectorAll('.babel-font')[1];
      this.boxA = window.document.querySelector('.box1');
      this.boxB = window.document.querySelector('.box2');
      setTimeout(() => {
  ...
  methods: {
    ...
    clickIt() {
      if (process.browser) {
        ...
        let babel1 = window.document.querySelectorAll('.babel-font')[0];
        let babel2 = window.document.querySelectorAll('.babel-font')[1];
        let windowWidth = window.innerWidth;
        let windowHeight = window.innerHeight;
        let edit = window.document.getElementsByClassName('edit')[0];
