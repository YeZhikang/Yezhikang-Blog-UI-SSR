<template>
  <div class="main-body">
    ...
    <div class="main-body__body">
      <div class="body__recent" v-for="(active, index) in actives" :key="active.activeId">
        ...
        <div class="main-body__body__message">
          ...
          <el-popover placement="top" width="160" v-model="active.isDeleteVis">
            <p>是否要删除该想法？</p>
        ...
        <el-popover v-if="!isFinished(active)" placement="top" width="250" v-model="active.visible">
          <p>添加动态</p>
          ...
          <div style="text-align: right; margin: 0;">
            ...
            <el-button type="primary" size="mini" @click="handleSubmitTag(active, active.activeId)">确定 </el-button>
          </div>
    ...
    <div class="main-body__foot" style="position: relative;">
      <div class="body__recent" style="width: 100%;">
        <div class="main-body__body__avator--add">
          <el-popover placement="top" v-model="emojiInfo.visible">
