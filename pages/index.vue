      ...
      <div class="recent-blog">
        ...
        <div class="article-list">
          <div v-for="(article,index) in articleLst" :key="index" class="fa" style="margin-top: 25px">
            ...
            <h4 style="width: 89%;padding: 0 15px;"><nuxt-link class="rl" :to="'/article/' + article.urlHash">{{article.file}}</nuxt-link></h4>
...
export default {
    ...
    asyncData(){
        return axios.post('https://www.yezhikang.site:8081/getArticles', { activeLabels: [], text: ''}).then(res => {

            return {
                articleLst: res.data.articles.reverse()
            }
        }).catch(error => {
            console.log(error)
        })
