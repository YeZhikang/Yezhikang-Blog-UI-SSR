  ...
  <div style="width: 100%">
    <div class="main">
      <div style="display: flex;align-items: center;width: 100%">
        <img
          class="imgLogo"
          :src="pngCate[blogInfo.category]"
        >
        <div>
          <h1
            class="title"
            style="word-break:break-all;margin-bottom: 0;margin-top: 0;"
          >{{blogInfo.file}}</h1>
          <span style="font-size: 13px;color: darkgrey;line-height: 1">{{blogInfo.time}} /
...
export default {
    ...
    asyncData({ params }) {
        return axios.post('https://www.yezhikang.site:8081/getmd', { hash: params.hash }).then(res => {
            console.log(res.data)
            // this.title = res.data.file;
            // this.time = res.data.time;
            // this.category = res.data.category;
