  ...
  <div style="height: 100%;">
    <div class="container">
      ...
      <div class="container__history">
        ...
        <div v-if="guessSit.isShow">
          这个数<span style="color: #3a8ee6;"> {{ guessSit.status }} </span>{{ trulyGuess }},

          <span
            >已经猜了 <span style="font-weight: 600; color: lightcoral;">{{ guessSit.count }} </span>次</span
          >
        </div>
        <div v-if="guessSit.isShow" ref="guess-bar" class="guess-bar">
