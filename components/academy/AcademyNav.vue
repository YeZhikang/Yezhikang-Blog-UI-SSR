<template>
    <div class="nav">
        ...
        >
            <img
                class="body__avatar"
                src="../../static/images/academy/academy-icon.jpeg"
                alt=""
            ...
            <transition name="el-zoom-in-top">
                <div
                    v-show="isCheckDetail"
                    ref="navCloser"
                    class="nav__closer"
                >
                    <div style="color: #006699">
                        <img
                            :src="currentNav.imageURL"
                            alt=""
                    ...
                    <div class="check-item">
                        <div
                            class="link-body"
                            v-for="link in currentNav.links.slice(0,3)"
                            :key="link.title"
                        >
                            <span
                                @click="handlePush(currentNav,link)"
                                class="aca-ao"
                            >{{ link.title }}</span>
                        </div>
                    </div>
                    <div class="check-item">
                        <div
                            class="link-body"
                            v-for="link in currentNav.links.slice(3)"
                            :key="link.title"
                        >
                            <span
                                @click="handlePush(currentNav,link)"
                    ...
                    <div class="reading">
                        <p style="font-size: 10px;color: rgb(88,88,88);margin-bottom: 15px;font-weight: 900">RELATED
                                                                                                             LINKS</p>
